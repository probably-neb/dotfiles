...
function httpspark
    bash ~/.config/fish/httpspark.sh
end

function wifispark
    bash ~/.config/fish/wifispark.sh
end

function loadaverage
   bash ~/.config/fish/loadaveragespark.sh
end
...
alias lt='exa -aTL 2 --color=always --group-directories-first --no-user' # tree listing
alias l.='exa -a | egrep "^\."'
...
# Function to identify colors being used #
