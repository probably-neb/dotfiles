...
-- fmata uses angle brackets as delimiters
...
local lsp_snippet = require('luasnip').parser.parse_snippet
-- }}}

local in_math_block = function()
    return vim.cmd [[ 'vimtex#syntax#in_mathzone()' ]] == '1'
end

require('neb.config.plugins.luasnips').enable_autosnippets()
...
local make_auto = function(fn, opts, ...)
    return fn(auto(opts),...)
end
...
-- setmetatable(M,M)
-- function M:auto()
--     self.snip.snippetType = "autosnippet"
--     -- P(self)
--     return self
-- end
-- function M:s()
...
-- snippet href "link with description"\\href{$1}{$2} $0
-- endsnippet
--
--
lsp_snippet({trig="beg", dscr="begin{} / end{}"},
    [[ 
    \\begin{$1}
    $2
    \\end{$1}
...
--
-- priority 100
s(auto({trig="...",dscr="ldots"}),t"\\ldots"),
s({trig="$$", dscr="math mode"}, {t'$',d(1,function(_args, snip)
...
s({trig="bf",dscr="bold font"}, {t"{\\bf ", l(l.TM_SELECTED_TEXT),t"} "}),
-- s(auto({trig="...",dscr="ldots"}),t"\\ldots"),
-- snippet ... "ldots" iA
-- \ldots
-- endsnippet
--
-- snippet table "Table environment"\begin{table}[${1:htpb}]
-- \centering
-- \caption{${2:caption}}
-- \label{tab:${3:label}}
-- \begin{tabular}{${5:c}}
...
-- endsnippet
--
-- snippet fig "Figure environment"\begin{figure}[${1:htpb}]
-- \centering
...
-- endsnippet
--
-- snippet desc "Description"\begin{description}
-- \item[$1] $0
-- \end{description}
-- endsnippet
--
-- snippet pac "Package"\usepackage[${1:options}]{${2:package}}$0
-- endsnippet
--
-- snippet => "implies" Ai
-- \implies
...
--
-- context "math()"
    s(auto({trig="td",dscr="to the ... power", wordTrig=false}), fmt([[
    ^{<>}
    ]],i(1))),
